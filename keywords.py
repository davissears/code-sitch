...
Two layers:
  ...
  * ai_keywords(): a richer pool generated by Claude from a compact digest of
    the conversation. Generated lazily in the background and cached forever.
...
_AI_PROMPT = """You generate search keywords for a developer's archive of past Claude Code coding sessions.
...
def ai_keywords(meta, model=MODEL_KEYWORDS, timeout=60):
    """Ask Claude for a keyword pool. Returns list[str] or None on failure."""
